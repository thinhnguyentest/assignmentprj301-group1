<%-- 
    Document   : faq
    Created on : Mar 4, 2024, 6:05:26 PM
    Author     : PC
--%>
    ...
    <head>
        ...
        <style>
            * {
            ...
            .faq {
                margin-top: 70px; /* Adjusted margin-top for better spacing */
            }
            ...
            .used-book{
                margin-left: 20px; /* Adjusted margin for better indentation */
            ...
            /* Added some spacing between questions */
            .general + p,
            .general + ul,
            .general + h3 {
                margin-top: 20px;
